...
import org.pleasure.easy.sequence.ConcurrentProxySequenceGenerator;
import org.pleasure.easy.sequence.RedisNotSafeLongSequenceGenerator;
 ...
 * @since 1.0
 */
public class ConcurrentProxySequenceGeneratorTest {
    ...
    public void test() {
        ...
        ConcurrentProxySequenceGenerator<Long> proxy = new ConcurrentProxySequenceGenerator<Long>(r);
